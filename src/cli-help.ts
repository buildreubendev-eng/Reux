...
const commandNames = [
  ...
  "rule-notifications-list",
  "rule-notification-resolve",
  "rule-notification-reopen",
] as const;
...
const commandDetails: Record<string, Partial<CliCommandInfo>> = {
  ...
  "view-ir": {
    category: "Generation",
    summary: "Emit View IR for one named view in a source file.",
    usage: "reux view-ir <source.dl|source.reux> <view-name>",
    examples: ["reux view-ir examples/plos_executive.reux DailyCommandBrief"],
  },
  "view-sql": {
    category: "Generation",
    summary: "Emit SQL for one named view in a source file.",
    usage: "reux view-sql <source.dl|source.reux> <view-name>",
    examples: ["reux view-sql examples/plos_executive.reux DailyCommandBrief"],
  },
  "view-run": {
    category: "Database",
    summary: "Run one named view against PostgreSQL and print the dashboard row as JSON.",
    usage: "reux view-run <source.dl|source.reux> <view-name>",
    examples: ["reux view-run examples/plos_executive.reux DailyCommandBrief"],
  },
  "rule-ir": {
    category: "Generation",
    summary: "Emit Rule IR for one named executable rule in a source file.",
    usage: "reux rule-ir <source.dl|source.reux> <rule-name>",
    examples: ["reux rule-ir examples/plos_executive.reux overdue_follow_up"],
  },
  "rule-sql": {
    category: "Generation",
    summary: "Emit SQL for one named executable rule in a source file.",
    usage: "reux rule-sql <source.dl|source.reux> <rule-name>",
    examples: ["reux rule-sql examples/plos_executive.reux overdue_follow_up"],
  },
  "rule-run": {
    category: "Database",
    summary: "Run one named executable rule against PostgreSQL and print action results as JSON.",
    usage: "reux rule-run <source.dl|source.reux> <rule-name>",
    examples: ["reux rule-run examples/plos_executive.reux overdue_follow_up"],
  },
  "rules-run": {
    category: "Database",
    summary: "Run all executable rules, or selected rules, against PostgreSQL.",
    usage: "reux rules-run <source.dl|source.reux> [rule-name ...]",
    examples: ["reux rules-run examples/plos_executive.reux", "reux rules-run examples/plos_executive.reux overdue_follow_up critical_risk_attention"],
  },
  "project-query-ir": {
    category: "Generation",
  ...
  "project-view-ir": {
    category: "Generation",
    summary: "Emit View IR for one named view in the configured project source.",
    usage: "reux project-view-ir <view-name>",
    examples: ["reux project-view-ir DailyCommandBrief"],
  },
  "project-view-sql": {
    category: "Generation",
    summary: "Emit SQL for one named view in the configured project source.",
    usage: "reux project-view-sql <view-name>",
    examples: ["reux project-view-sql DailyCommandBrief"],
  },
  "project-view-run": {
    category: "Database",
    summary: "Run one named project view against PostgreSQL and print the dashboard row as JSON.",
    usage: "reux project-view-run <view-name>",
    examples: ["reux project-view-run DailyCommandBrief"],
  },
  "project-rule-ir": {
    category: "Generation",
    summary: "Emit Rule IR for one named executable rule in the configured project source.",
    usage: "reux project-rule-ir <rule-name>",
    examples: ["reux project-rule-ir overdue_follow_up"],
  },
  "project-rule-sql": {
    category: "Generation",
    summary: "Emit SQL for one named executable rule in the configured project source.",
    usage: "reux project-rule-sql <rule-name>",
    examples: ["reux project-rule-sql overdue_follow_up"],
  },
  "project-rule-run": {
    category: "Database",
    summary: "Run one named project rule against PostgreSQL and print action results as JSON.",
    usage: "reux project-rule-run <rule-name>",
    examples: ["reux project-rule-run overdue_follow_up"],
  },
  "project-rules-run": {
    category: "Database",
    summary: "Run all executable project rules, or selected rules, against PostgreSQL.",
    usage: "reux project-rules-run [rule-name ...]",
    examples: ["reux project-rules-run", "reux project-rules-run overdue_follow_up critical_risk_attention"],
  },
  explain: {
    category: "Generation",
  ...
  "rule-notifications-list": {
    category: "Outbox",
    summary: "List rule notification inbox records by status.",
    usage: "reux rule-notifications-list [open|resolved|all] [limit]",
    examples: ["reux rule-notifications-list", "reux rule-notifications-list all 25"],
  },
  "rule-notification-resolve": {
    category: "Outbox",
    summary: "Resolve one rule notification inbox record.",
    usage: "reux rule-notification-resolve <rule-name> <entity-name> <record-id> <recipient-field>",
    examples: ["reux rule-notification-resolve critical_risk_attention RiskItem risk-1 owner"],
  },
  "rule-notification-reopen": {
    category: "Outbox",
    summary: "Reopen one resolved rule notification inbox record.",
    usage: "reux rule-notification-reopen <rule-name> <entity-name> <record-id> <recipient-field>",
    examples: ["reux rule-notification-reopen critical_risk_attention RiskItem risk-1 owner"],
  },
};
