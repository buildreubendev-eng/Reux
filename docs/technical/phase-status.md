...
- Supports `load ... for update`, simple loaded-entity mutations, transition-guarded enum assignments, `insert Entity { ... }`, enum-valued transaction writes, and durable `enqueue Event { ... }`.
