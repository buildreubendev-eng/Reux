...
- Simulation declarations with static assumptions, lightweight units, formulas, time-varying changes, scenarios, forecast windows, Simulation IR, and a prototype formula forecast runner.
...
2. Simulation language foundation: first slices complete with static `simulate` declarations, arithmetic formulas, lightweight units, scheduled assumption changes, scenario overrides, and a prototype runner; remaining work is richer dimensional analysis, scenario-specific timelines, richer comparison reports, and generated TypeScript contracts.
