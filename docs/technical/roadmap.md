...
- Simulation declarations with static assumptions, lightweight units, formulas, scenarios, forecast windows, Simulation IR, and a prototype formula forecast runner.
...
2. Simulation language foundation: first slices complete with static `simulate` declarations, arithmetic formulas, lightweight units, scenario overrides, and a prototype runner; remaining work is richer dimensional analysis, time-varying assumptions, richer comparison reports, and generated TypeScript contracts.
