...
The TypeScript simulation contract emitter generates reusable run/result interfaces plus simulation-specific assumption, metric, scenario, explanation, and run types. It also exports metadata constants with forecast windows, assumptions, metrics, objectives, and scenario names so web apps can wire UI controls without hand-copying source details:
