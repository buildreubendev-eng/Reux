...
- Public demo scope: commerce workflows, logistics workflows, Business Simulator workflows, isolated visitor sessions, temporary saved simulation runs, transaction execution, PostgreSQL-backed state, queue/outbox processing, and health checks.
...
- Public Business Simulator demo with temporary saved run records for result pages and sharing.
