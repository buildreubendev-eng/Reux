...
- Language Core: prototype-complete. The prototype language core can model schemas, enums, reusable typed queries, guarded transaction functions, durable events, migrations, simulations, executable aggregate views, and executable single-entity operating-model rules. (8 capabilities)
