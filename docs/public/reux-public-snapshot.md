...
- Public Demo: live. The hosted demo lets public users test commerce, logistics, and Business Simulator workflows with isolated visitor sessions, generic Reux simulation execution, and temporary saved simulation runs. (8 capabilities)
